...
export function Greeter({ genres, onSubmit, onShowPrivacy }: GreeterProps) {
  ...
  return (
    <div>
      <div class="mx-auto max-w-2xl px-4 pt-12">
        ...
        <div class="relative pb-20">
          ...
          <div class="fixed right-0 top-1/2 z-30 flex -translate-y-1/2 flex-col rounded-l bg-white/90 text-[9px] leading-[1.1] dark:bg-neutral-950/90">
            {LETTERS.map((l) => {
              ...
              return (
                <button
                  ...
                  class={`cursor-pointer px-2 py-0.5 text-center font-medium ${
                    hasLetter
      ...
      {/* Sticky bottom bar — border at content width, blur runs full width */}
      <div class="sticky bottom-0 z-20">
        <div class="mx-auto max-w-2xl px-4">
          <div class="h-0 border-t border-neutral-200 dark:border-neutral-700"></div>
        </div>
        <div class="bg-white/80 pb-4 backdrop-blur-sm dark:bg-neutral-950/80">
          <div class="mx-auto max-w-2xl px-4 pt-3 text-center">
            <button
              type="button"
